...
/// [MS-EMFPLUS] 2.3.4.17 EmfPlusFillPath Record
...
public struct EmfPlusFillPath {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// Type (2 bytes): An unsigned integer that identifies this record type as EmfPlusFillPath from the RecordType
        /// enumeration.
        /// The value MUST be 0x4014.
        self.type = try RecordType(dataStream: &dataStream)
        guard self.type == .fillPath else {
    ...
    public struct Flags {
        ...
        public init(dataStream: inout DataStream) throws {
            ...
            /// ObjectId (1 byte): The index of the EmfPlusPath object to fill, in the EMF+ Object Table.
