...
/// [MS-EMFPLUS] 2.3.3.2 EmfPlusGetDC Record
/// The EmfPlusGetDC record specifies that subsequent EMF records ([MS-EMF] section 2.3) encountered in the metafile SHOULD be
/// processed.
...
public struct EmfPlusGetDC {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// Type (2 bytes): An unsigned integer that identifies this record type as EmfPlusGetDC from the RecordType enumeration.
        /// The value MUST be 0x4004.
        self.type = try RecordType(dataStream: &dataStream)
        guard self.type == .getDC else {
