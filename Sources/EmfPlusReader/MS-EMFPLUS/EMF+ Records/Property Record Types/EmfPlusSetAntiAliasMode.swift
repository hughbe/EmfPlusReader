...
/// [MS-EMFPLUS] 2.3.6.1 EmfPlusSetAntiAliasMode Record
...
public struct EmfPlusSetAntiAliasMode {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// Type (2 bytes): An unsigned integer that identifies this record type as EmfPlusSetAntiAliasMode from the RecordType
        /// enumeration.
        /// The value MUST be 0x401E.
        self.type = try RecordType(dataStream: &dataStream)
        guard self.type == .setAntiAliasMode else {
    ...
    /// structure of the record.
    public struct Flags {
        public let performAntiAliasing: Bool
        public let smoothingMode: SmoothingMode
        ...
        public init(dataStream: inout DataStream) throws {
            ...
            self.performAntiAliasing = flags.readBit()
            
            /// SmoothingMode (7 bits): The smoothing mode value, from the SmoothingMode enumeration.<26>
            guard let smoothingMode = SmoothingMode(rawValue: UInt8(flags.readBits(count: 7))) else {
                throw EmfPlusReadError.corrupted
            }
