//
//  EmfPlusResetWorldTransform.swift
//
//
...
/// [MS-EMFPLUS] 2.3.9.2 EmfPlusResetWorldTransform Record
...
public struct EmfPlusResetWorldTransform {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// Type (2 bytes): An unsigned integer that identifies this record type as EmfPlusResetWorldTransform from the RecordType
        /// enumeration.
        /// The value MUST be 0x402B.
        self.type = try RecordType(dataStream: &dataStream)
        guard self.type == .resetWorldTransform else {
