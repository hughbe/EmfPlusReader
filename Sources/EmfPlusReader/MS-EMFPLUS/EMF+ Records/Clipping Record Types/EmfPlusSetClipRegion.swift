...
/// [MS-EMFPLUS] 2.3.1.5 EmfPlusSetClipRegion Record
/// The EmfPlusSetClipRegion record combines the current clipping region with another graphics region.
/// The new current clipping region is set to the result of performing the CombineMode operation on the previous current clipping region
/// and the specified EmfPlusRegion object.
/// See section 2.3.1 for the specification of additional clipping record types.
public struct EmfPlusSetClipRegion {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// Type (2 bytes): An unsigned integer that identifies this record type as EmfPlusSetClipRegion from the RecordType
        /// enumeration.
        /// The value MUST be 0x4034.
        self.type = try RecordType(dataStream: &dataStream)
        guard self.type == .setClipRegion else {
    ...
    public struct Flags {
        ...
        public init(dataStream: inout DataStream) throws {
            ...
            /// ObjectID (1 byte): The index of an EmfPlusRegion object in the EMF+ Object Table.
