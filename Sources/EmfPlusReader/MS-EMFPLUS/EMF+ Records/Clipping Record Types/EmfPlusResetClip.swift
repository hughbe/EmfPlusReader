...
/// [MS-EMFPLUS] 2.3.1.2 EmfPlusResetClip Record
...
public struct EmfPlusResetClip {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// Type (2 bytes): An unsigned integer that identifies this record type as EmfPlusResetClip from the RecordType enumeration.
        /// The value MUST be 0x4031.
        self.type = try RecordType(dataStream: &dataStream)
        guard self.type == .resetClip else {
